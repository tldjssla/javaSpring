...
@Controller
public class MoAccountController {
	...
	@RequestMapping(value = "/makeAccount.mo", method = RequestMethod.GET)
	public ModelAndView makeAccount(Account account) {
		...
		modelAndView.setViewName("moviews/makeAccount_Form");
		// get방식일 경우 우선 개설할 계좌 정보를 입력받는 페이지를 보여준다.
		
		return modelAndView;
	}
	// 계좌정보 입력 후, 실제 계좌를 개설하는 메소드. POST 방식으로 받는다.
	@RequestMapping(value = "/makeAccountAction.mo", method = RequestMethod.POST)
	public ModelAndView makeAccountLogic(Account account) {
		
		ModelAndView modelAndView = new ModelAndView();
		modelAndView.setViewName("moviews/allAccInfo");
	...
	@RequestMapping(value = "/searchAccount.mo", method = RequestMethod.GET)
	public ModelAndView searchAccount(Account account) {

		ModelAndView modelAndView = new ModelAndView();
		modelAndView.setViewName("moviews/accInfo_Form");
		return modelAndView;
	}
	
	// 실제 계좌를 조회
	@RequestMapping(value = "/accInfoAction.mo", method = RequestMethod.POST)
	public ModelAndView searchAccountLogic(Account account) {

		ModelAndView modelAndView = new ModelAndView();
		modelAndView.setViewName("moviews/accInfo");
	...
	// 결과값을 addObject 해 준다.
	@RequestMapping(value = "/searchAllAccount.mo", method = RequestMethod.GET)

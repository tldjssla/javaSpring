...
public class MoBankingController {
	...
	@RequestMapping(value = "/deposit.mo", method = RequestMethod.GET)
	public ModelAndView deposit(Account account) {

		ModelAndView modelAndView = new ModelAndView();
		modelAndView.setViewName("moviews/deposit_Form");
		return modelAndView;
	}
	
	// 실제 입금 처리
	@RequestMapping(value = "/depositAction.mo", method = RequestMethod.POST)
	...
	@RequestMapping(value = "/withdraw.mo", method = RequestMethod.GET)
	public ModelAndView withdraw(Account account) {

		ModelAndView modelAndView = new ModelAndView();
		modelAndView.setViewName("moviews/withdraw_Form");
		
		return modelAndView;
	}
	
	// 실제 출금 처리
	@RequestMapping(value = "/withdrawAction.mo", method = RequestMethod.POST)
